     ...
     <div class="row align-items-center">
         ...
         <div class="col-sm-6">
            <div class="float-end d-none d-sm-block">
                <a href="<?= base_url();?>portal/#app/feed/add" class="btn btn-success"><i class="fas fa-plus"></i> Add Feed</a>
            </div>
         </div>
     </div>
    </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <a href="<?= base_url();?>portal/#app/feed/detail/1" class="btn btn-primary btn-sm waves-effect waves-light datatable-edit">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?= base_url();?>portal/#app/feed/edit/1" class="btn btn-warning btn-sm waves-effect waves-light datatable-edit">
